...
public class RecipeBiblioAtlas extends ShapedRecipes
{
	...
	public RecipeBiblioAtlas(int a, int b, ItemStack[] stacks, ItemStack stack)
	{
		super(a, b, stacks, stack);
	}
    ...
    public ItemStack getCraftingResult(InventoryCrafting inv)
    {
        ...
        if (oldAtlas != null)
        {
			...
			enchantments.setInteger("id", BiblioCraft.deathCompassEnch.effectId);
        ...
        for (int k = 0; k < 3; ++k)
        {
            for (int l = 0; l < 3; ++l)
            {
                ...
                if (itemstack1 != null || itemstack != null)
                {
                    ...
                    if (itemstack != null && itemstack.getItemDamage() != 32767 && itemstack.getItemDamage() != itemstack1.getItemDamage())
                    {
                        return false;
                    }
                }
    ...
    public static IRecipe addAtlasEnchantRecipe(ItemStack stack, Object ... stuff)
    {
        ...
        for (hashmap = new HashMap(); i < stuff.length; i += 2)
        {
            ...
            {
                itemstack1 = new ItemStack((Block) stuff[i + 1]);
            }
...
//            }
        ...
        if (aitemstack.length >= 5)
        {
	        //ItemStack oldAtlas = aitemstack.get(4);
            ItemStack oldAtlas = aitemstack[4];
	        if (oldAtlas != null)
	        {
