...
public class ItemSeatBack3 extends Item
{
    ...
    public void getSubItems(Item item, CreativeTabs tab, List<ItemStack> list)//Item itemID, CreativeTabs tabs, List list)
    {
    ...
    public void registerIcons(IIconRegister register) {
        this.itemIcon = register.registerIcon("bibliocraft:seatback3");
    }
}
