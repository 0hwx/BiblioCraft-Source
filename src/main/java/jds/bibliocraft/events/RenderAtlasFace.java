...
//		    }
//
//		    if (event.getHand() == EnumHand.MAIN_HAND && mc.player.getHeldItem(EnumHand.OFF_HAND) != null && mc.player.getHeldItem(EnumHand.OFF_HAND).getItem() != Items.AIR)
//		    {
//		    	isSmallRight = true;
//		    }
//
...
//        GL11.glTranslated(0.0F, -f1 / 2.0F, f2);
//        GL11.glTranslated(0.0F, 0.04F + equip * -1.2F + pitch * -0.5F, -0.72F);
//        GL11.glRotatef(pitch * -85.0F, 1.0F, 0.0F, 0.0F);
//
//		GL11.glTranslated(0.38 + 0.0, 0.38, -0.7 + 0.68);
...
//			if (smallRight)
//			{
//				GL11.glTranslated(0.0, -0.885, -0.865);
//			}
//			else
//			{
//				GL11.glTranslated(0.0, -0.885, 1.66);
//			}
//		}
//
//		GL11.glScalef(0.76, 0.76, 0.76);
//		GL11.glTranslated(0.0f, piny, pinx);
