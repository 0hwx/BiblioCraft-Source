...
public class GuiNameTester extends GuiContainer
{
	...
	protected void drawGuiContainerBackgroundLayer(float f, int x, int y)
	{
		...
		this.fontRendererObj.drawString(I18n.format("gui.testeritem.name"), w+30, h+16, 0x000000, false);
		this.fontRendererObj.drawString(I18n.format("gui.testeritem.display"), w+32, h+62, 0x6A6A6A, false);
		this.fontRendererObj.drawString(I18n.format("gui.testeritem.unlocal"), w+32, h+82, 0x5A5A5A, false);
		this.fontRendererObj.drawString("Meta Value:", w+32, h+102, 0x5A5A5A, false);
		if (this.currentStack != null)
		{

			this.fontRendererObj.drawString(this.currentStack.getDisplayName(), w+42, h+72, 0x00AA00, false);

			this.fontRendererObj.drawString(this.currentStack.getUnlocalizedName(), w+42, h+92, 0x00AA00, false);

			this.fontRendererObj.drawString(this.currentStack.getItemDamage()+"", w+92, h+102, 0x00AA00, false);

			//RegistryNamespaced registry = GameData.getBlockRegistry();
			//
			//this.fontRendererObj.drawString(GameData.getBlockRegistry().getNameForObject(currentStack), w+59, h+82, 0x000000, false);
	...
	public void updateScreen()
    {
    	...
    	if (stack != null && stack.getItem() instanceof ItemNameTester)
    	{
