...
public class GuiWritingDesk extends GuiContainer
{
	...
	{
		this.fontRendererObj.drawString(I18n.format("gui.desk"), 58, 6, 4210752); // changes these from 8 to 42
		this.fontRendererObj.drawString(I18n.format("container.inventory"), 64, ySize - 96 + 2, 4210752);
	}
