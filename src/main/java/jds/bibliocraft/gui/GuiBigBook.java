...
public class GuiBigBook extends GuiScreen
{
    ...
    private String signingInstruct = ""+ ChatFormatting.ITALIC+I18n.format("book.entertitle");
    private String signingNotice = ""+ChatFormatting.ITALIC+I18n.format("book.signnotice");
    private String signedBy = ""+ChatFormatting.ITALIC+I18n.format("book.by");
	...
	private String textScale = I18n.format("book.textscale");
	private String lineSelected = I18n.format("book.lineselected");
	...
	public GuiBigBook(ItemStack bigbook, boolean inhand, int tx, int ty, int tz, String author)
	{
    	...
    	mods[0][0] = ""+ChatFormatting.BLACK;
    	mods[0][1] = ""+ChatFormatting.DARK_BLUE;
    	mods[0][2] = ""+ChatFormatting.DARK_GREEN;
    	mods[0][3] = ""+ChatFormatting.DARK_AQUA;
    	mods[1][0] = ""+ChatFormatting.DARK_RED;
    	mods[1][1] = ""+ChatFormatting.DARK_PURPLE;
    	mods[1][2] = ""+ChatFormatting.GOLD;
    	mods[1][3] = ""+ChatFormatting.GRAY;
     	mods[2][0] = ""+ChatFormatting.DARK_GRAY;
    	mods[2][1] = ""+ChatFormatting.BLUE;
    	mods[2][2] = ""+ChatFormatting.GREEN;
    	mods[2][3] = ""+ChatFormatting.AQUA;
     	mods[3][0] = ""+ChatFormatting.RED;
    	mods[3][1] = ""+ChatFormatting.LIGHT_PURPLE;
    	mods[3][2] = ""+ChatFormatting.YELLOW;
    	mods[3][3] = ""+ChatFormatting.WHITE;
    	for (int n=0; n<44; n++)
    	{
    		//this.lineScales[n] = defaultTextScale;
    	}
	...
	public void saveSigningToNBT()
	{
		...
		if (tags != null)
		{
			...
			display.setString("Name",ChatFormatting.WHITE+this.signTextField.getText());
    ...
    public void initGui()
    {
    	...
    	if (!(signed || signing))
    	{
	    	buttonList.add(this.buttonBold = new GuiButton(10, widthLocal-60, heightLocal+25, 20, 20, ChatFormatting.BOLD+I18n.format("book.bold")));
	    	buttonList.add(this.buttonItalic = new GuiButton(11, widthLocal-40, heightLocal+25, 20, 20, ChatFormatting.ITALIC+I18n.format("book.italic")));
	    	buttonList.add(this.buttonUnderline = new GuiButton(12, widthLocal-20, heightLocal+25, 20, 20, ChatFormatting.UNDERLINE+I18n.format("book.underline")));
	    	buttonList.add(this.buttonStrike = new GuiButton(13, widthLocal-60, heightLocal+45, 40, 20, ChatFormatting.STRIKETHROUGH+I18n.format("book.strike")));
	    	buttonList.add(this.buttonObfusticate = new GuiButton(14, widthLocal-20, heightLocal+45, 20, 20, ChatFormatting.OBFUSCATED+I18n.format("book.obfuscated")));
	    	buttonList.add(this.buttonReset = new GuiButton(15, widthLocal-60, heightLocal+118, 60, 20, I18n.format("book.reset")));
	    	...
	    	buttonList.add(this.buttonSave = new GuiButton(0, widthLocal-60, heightLocal+228, 60, 20, I18n.format("book.save")));
	    	buttonList.add(this.buttonSign = new GuiButton(1, widthLocal-60, heightLocal+204, 60, 20, I18n.format("book.sign")));
    	}
    	...
    	for (int n=0; n<44; n++)
    	{
    		this.lines[n] = new GuiBiblioTextField(fontRendererObj, (int)((widthLocal+15)*antiscales[lineScales[n]]),(int)(((heightLocal+15)*antiscales[lineScales[n]])+(linespace*antiscales[lineScales[n]])), (int)(193*antiscales[lineScales[n]]), 8);
    	...
    	for (int n=0; n<16; n++)
    	{
    		if (n%2 == 0)
    		{
    			this.chapters[n] = new GuiBiblioTextField(fontRendererObj, (widthLocal+224), (heightLocal+11+(15*n)), 75, 8);
    		}
    		else
    		{
    			this.chapters[n] = new GuiBiblioTextField(fontRendererObj, (widthLocal+224), (heightLocal+21+(15*(n-1))), 75, 8);
    		}
    	...
    	if (signing)
    	{
    		...
    		this.buttonPageForward.enabled = false;
    		this.buttonPageLast.enabled = false;
    		buttonList.add(this.buttonSignCancel = new GuiButton(2, widthLocal+20, heightLocal+204, 80, 20, I18n.format("book.cancel")));
    		buttonList.add(this.buttonSignAccept = new GuiButton(3, widthLocal+120, heightLocal+204, 80, 20, I18n.format("book.sign")));
	...
	public void drawScreen(int x, int y, float f)
	{
		...
		if (!(signing || signed))
		{
			...
			this.drawCenteredString(this.fontRendererObj, I18n.format("book.linenum") , widthLocal-39, heightLocal+178, 0xFFFFFF);
	...
	protected void actionPerformed(GuiButton click)
    {
    	...
    	switch (click.id)
    	{
    		...
    		case(10):
    		{
    			String moddedLine = addTextMod(lines[this.currentLine].getText(), ChatFormatting.BOLD+"");
    			lines[this.currentLine].setText(moddedLine);
    			break;
    		}
    		case(11):
    		{
    			String moddedLine = addTextMod(lines[this.currentLine].getText(), ChatFormatting.ITALIC+"");
    			lines[this.currentLine].setText(moddedLine);
    			break;
    		}
    		case(12):
    		{
    			String moddedLine = addTextMod(lines[this.currentLine].getText(), ChatFormatting.UNDERLINE+"");
    			lines[this.currentLine].setText(moddedLine);
    			break;
    		}
    		case(13):
    		{
    			String moddedLine = addTextMod(lines[this.currentLine].getText(), ChatFormatting.STRIKETHROUGH+"");
    			lines[this.currentLine].setText(moddedLine);
    			break;
    		}
    		case(14):
    		{
    			String moddedLine = addTextMod(lines[this.currentLine].getText(), ChatFormatting.OBFUSCATED+"");
    			lines[this.currentLine].setText(moddedLine);
    			break;
    		}
    		case(15):
    		{
    			String moddedLine = addTextMod(lines[this.currentLine].getText(), ChatFormatting.RESET+"");
    			lines[this.currentLine].setText(moddedLine);
    			break;
    		}
    		case(16):
    ...
    public void sendPacket()
    {
    	...
    	{
			BiblioNetworking.INSTANCE.sendToServer(new BiblioMCBEdit(tilex, tiley, tilez, this.currentPage, book));
