...
public class GuiClock extends GuiScreen
{
	...
	private String stringTick = I18n.format("gui.clock.ticksound");//"Tick Sound";
	private String stringChimeSound = I18n.format("gui.clock.chimesound");//"Chime Sound";
	private String stringRedstone = I18n.format("gui.clock.redstone");//"Redstone";
	private String stringChime = I18n.format("gui.clock.chime");//"Chime";
	private String stringPreset = I18n.format("gui.clock.presets");//"Presets";

	private String stringPulse[] = {I18n.format("gui.clock.pulse"), I18n.format("gui.clock.solid")};
	private int pulse = 0;
	...
	public void drawScreen(int x, int y, float f)
	{
		...
		buttonCPreset1.drawButton(mc, 0, 0);
		buttonCPreset2.drawButton(mc, 0, 0);
		buttonCPreset3.drawButton(mc, 0, 0);
		buttonCPreset4.drawButton(mc, 0, 0);
		buttonCPreset5.drawButton(mc, 0, 0);
		buttonRPreset1.drawButton(mc, 0, 0);
		buttonRPreset2.drawButton(mc, 0, 0);
		buttonRPreset3.drawButton(mc, 0, 0);
		buttonRPreset4.drawButton(mc, 0, 0);
		buttonRPreset5.drawButton(mc, 0, 0);


		GL11.glScalef(0.6f, 0.6f, 0.6f);
		int wx = (int) ((1.0f/0.6f)*(w+29));
		int hy = (int) ((1.0f/0.6f)*(h+152));
		this.drawCenteredString(this.fontRendererObj, this.stringChime, wx-22, hy-240, 0x00FF00);
		this.drawCenteredString(this.fontRendererObj, this.stringPreset, wx-22, hy-230, 0x00FF00);
		this.drawCenteredString(this.fontRendererObj, this.stringRedstone, wx+217, hy-240, 0xFF0000);
		this.drawCenteredString(this.fontRendererObj, this.stringPreset, wx+217, hy-230, 0xff0000);
		this.drawCenteredString(this.fontRendererObj, this.stringTick, wx, hy, 0xffffff);
		this.drawCenteredString(this.fontRendererObj, this.stringChimeSound, wx+100, hy, 0xffffff);
		this.drawCenteredString(this.fontRendererObj, this.stringRedstone, wx+200, hy, 0xffffff);
		this.drawCenteredString(this.fontRendererObj, this.stringPulse[this.pulse], wx+199, hy-27, 0xffffff);
    ...
    public void sendPacket()
    {
    	...
    	BiblioNetworking.INSTANCE.sendToServer(new BiblioClock(tags, this.toggleTick, this.toggleChime, this.toggleRedstone, (this.pulse < 1) ? true : false, this.clock.xCoord, this.clock.yCoord, this.clock.zCoord));
