...
public class GuiAtlasWaypointTransfer extends GuiScreen
{
    ...
    public void initGui()
    {
		...
		this.buttonList.add(bCancel = new GuiButton(0, w+220, h+80, 40, 20, I18n.format("gui.atlas.transfer.cancel")));
		this.buttonList.add(bUpArrow = new GuiButtonAtlasTransfer(1, w+20, h+13, I18n.format("gui.atlas.transfer.from"), false));
		this.buttonList.add(bDownArrow = new GuiButtonAtlasTransfer(2, w+20, h+52, I18n.format("gui.atlas.transfer.to"), true));
    }
    ...
    private void sendTransferPacket(boolean toMapFrame)
    {
		...
		BiblioNetworking.INSTANCE.sendToServer(new BiblioAtlasWPT(toMapFrame, frameTile.xCoord, frameTile.yCoord, frameTile.zCoord, this.atlasStack));
	...
	public void drawScreen(int mousex, int mousey, float f)
	{
		...
		this.bCancel.drawButton(mc, 0, 0);
		//this.bCancel.drawButtonForegroundLayer(mouseX, mouseY);
		super.drawScreen(mousex, mousey, f);

		this.fontRendererObj.drawString(I18n.format("gui.atlas.transfer"), w+80, h+43, 4210752, false);
