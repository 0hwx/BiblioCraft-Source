...
public class GuiButtonAtlasTransfer extends GuiButton
{
	...
	public void drawButton(Minecraft mc, int par1, int par2)
    {
        if (this.visible)
        {
            ...
            if (downArrow)
            {
            	this.drawTexturedModalRect(this.xPosition, this.yPosition, 0, 196, this.width, this.height);
            }
            else
            {
            	this.drawTexturedModalRect(this.xPosition, this.yPosition, 0, 164, this.width, this.height);
            }
            ...
            if (pressed)
            {
            	if (downArrow)
            	{
            		this.drawTexturedModalRect(this.xPosition, this.yPosition, 0, 132, this.width, this.height);
            	}
            	else
            	{
            		this.drawTexturedModalRect(this.xPosition, this.yPosition, 0, 100, this.width, this.height);
            	}
            ...
            this.drawCenteredString(fontrenderer, this.displayString, this.xPosition + this.width / 2, this.yPosition + offset + (this.height - 8) / 2, l);
        }
    }
}
