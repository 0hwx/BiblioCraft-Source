...
public class GuiFancySign extends GuiContainer {
	...
	private String[] rots = { I18n.format("gui.sign.left"), I18n.format("gui.sign.center"),
			I18n.format("gui.sign.right") };
	...
	private String[] tiptextcolors = { ChatFormatting.BLACK + I18n.format("gui.sign.black"),
			ChatFormatting.DARK_BLUE + I18n.format("gui.sign.darkblue"),
			ChatFormatting.DARK_GREEN + I18n.format("gui.sign.darkgreen"),
			ChatFormatting.DARK_AQUA + I18n.format("gui.sign.darkaqua"),
			ChatFormatting.DARK_RED + I18n.format("gui.sign.darkred"),
			ChatFormatting.DARK_PURPLE + I18n.format("gui.sign.darkpurple"),
			ChatFormatting.GOLD + I18n.format("gui.sign.gold"),
			ChatFormatting.GRAY + I18n.format("gui.sign.gray"),
			ChatFormatting.DARK_GRAY + I18n.format("gui.sign.darkgray"),
			ChatFormatting.BLUE + I18n.format("gui.sign.blue"),
			ChatFormatting.GREEN + I18n.format("gui.sign.green"),
			ChatFormatting.AQUA + I18n.format("gui.sign.aqua"),
			ChatFormatting.RED + I18n.format("gui.sign.red"),
			ChatFormatting.LIGHT_PURPLE + I18n.format("gui.sign.lightpurple"),
			ChatFormatting.YELLOW + I18n.format("gui.sign.yellow"),
			ChatFormatting.WHITE + I18n.format("gui.sign.white") };
	...
	public void initGui() {
		...
		for (int n = 0; n < 15; n++) {
			...
			this.text[n] = new GuiBiblioTextField(this.fontRendererObj, textX, textY, 240, 8);
	...
	public void sendPacket()
    {
		...
		BiblioNetworking.INSTANCE.sendToServer(new BiblioSign(strings, textScales, numOfLines, this.slot1Scale, this.slot1Rot, this.slot2Scale, this.slot2Rot, this.xAdjust1, this.yAdjust1, this.xAdjust2, this.yAdjust2, this.signTile.xCoord, this.signTile.yCoord, this.signTile.zCoord));
	...
	protected void drawGuiContainerBackgroundLayer(float var1, int x, int y) {
		...
		switch (this.editing) {
			case 0: {
				...
				this.fontRendererObj.drawSplitString(I18n.format("gui.sign.tooltip1"),
				...
				if (x > (w + 197) && x <= (w + 206) && y > (h + 189) && y <= (h + 200)) // slot 1 info guide
				{
					...
					this.fontRendererObj.drawSplitString(I18n.format("gui.sign.tooltip2"),
				...
				if (x > (w + 211) && x <= (w + 220) && y > (h + 189) && y <= (h + 200)) // text slot info guide
				{
					...
					GL11.glScaled(0.7, 0.7, 0.7);
					GL11.glColor3f(0.0f, 0.0f, 0.0f);
					this.fontRendererObj.drawSplitString(I18n.format("gui.sign.tooltip3"),
							(int) ((x + 10) * (1.0 / 0.7)), (int) ((y - 4) * (1.0 / 0.7)), 125, 0x000000);
					GL11.glScaled(1.0 / 0.7, 1.0 / 0.7, 1.0 / 0.7);
				}
				// GL11.glColor3f(1.0f, 1.0f, 1.0f);
				if (x > (w + 225) && x <= (w + 234) && y > (h + 189) && y <= (h + 200)) // slot 2 info guide
				{
					...
					GL11.glScaled(0.7, 0.7, 0.7);
					GL11.glColor3f(1.0f, 1.0f, 1.0f);
					this.fontRendererObj.drawSplitString(I18n.format("gui.sign.tooltip4"),
							(int) ((x + 10) * (1.0 / 0.7)), (int) ((y - 4) * (1.0 / 0.7)), 125, 0x000000);
					GL11.glScaled(1.0 / 0.7, 1.0 / 0.7, 1.0 / 0.7);
				}
				GL11.glColor3f(1.0f, 1.0f, 1.0f);
			...
			case 1: {
				...
				if (x > (w + 239) && x <= (w + 248) && y > (h + 193) && y <= (h + 204)) {
					...
					GL11.glScaled(0.7, 0.7, 0.7);
					this.fontRendererObj.drawSplitString(I18n.format("gui.sign.tooltip5"),
				...
				if (x > (w + 239) && x <= (w + 248) && y > (h + 206) && y <= (h + 217)) {
					this.drawTexturedModalRect(x + 2, y - 7, 0, 75, 100, 48);
					GL11.glScaled(0.7, 0.7, 0.7);
					this.fontRendererObj.drawSplitString(I18n.format("gui.sign.tooltip6"),
				...
				if (x > (w + 239) && x <= (w + 248) && y > (h + 231) && y <= (h + 242)) {
					...
					GL11.glScaled(0.7, 0.7, 0.7);
					this.fontRendererObj.drawSplitString(I18n.format("gui.sign.tooltip7"),
				...
				this.fontRendererObj.drawString(rots[this.slot1Rot],
						(int) ((w + 216 - (3 * (rots[this.slot1Rot].length() / 2))) * (1.0 / 0.55)),
						(int) ((h + 209) * (1.0 / 0.55)), 0x000000, false);
				GL11.glPopMatrix();

				this.fontRendererObj.drawString(scaleItemsStrings[this.slot1Scale], ((w + 210)), ((h + 196)), 0x000000,
						false);
				break;
			}
			case 2: {
				...
				this.fontRendererObj.drawString(rots[this.slot2Rot],
						(int) ((w + 216 - (3 * (rots[this.slot2Rot].length() / 2))) * (1.0 / 0.55)),
						(int) ((h + 209) * (1.0 / 0.55)), 0x000000, false);
				GL11.glPopMatrix();

				this.fontRendererObj.drawString(scaleItemsStrings[this.slot2Scale], ((w + 210)), ((h + 196)), 0x000000,
						false);
			...
			case 3: {
				...
				if (x > (w + 237) && x <= (w + 246) && y > (h + 219) && y <= (h + 230)) {
					...
					GL11.glPushMatrix();
					GL11.glScaled(0.7, 0.7, 0.7);
					this.fontRendererObj.drawSplitString(I18n.format("gui.sign.tooltip8"),
							(int) ((x + 10) * (1.0 / 0.7)), (int) ((y - 145) * (1.0 / 0.7)), 124, 0x000000);
					this.fontRendererObj.drawSplitString("k = " + ChatFormatting.OBFUSCATED + "Obfuscated",
							(int) ((x + 10) * (1.0 / 0.7)), (int) ((y - 114) * (1.0 / 0.7)), 120, 0x000000);
					this.fontRendererObj.drawSplitString(
							"l = " + ChatFormatting.BOLD + I18n.format("gui.sign.bold"),
							(int) ((x + 10) * (1.0 / 0.7)), (int) ((y - 108) * (1.0 / 0.7)), 120, 0x000000);
					this.fontRendererObj.drawSplitString(
							"m = " + ChatFormatting.STRIKETHROUGH + I18n.format("gui.sign.strikethrough"),
							(int) ((x + 10) * (1.0 / 0.7)), (int) ((y - 102) * (1.0 / 0.7)), 120, 0x000000);
					this.fontRendererObj.drawSplitString(
							"n = " + ChatFormatting.UNDERLINE + I18n.format("gui.sign.underline"),
							(int) ((x + 10) * (1.0 / 0.7)), (int) ((y - 96) * (1.0 / 0.7)), 120, 0x000000);
					this.fontRendererObj.drawSplitString(
							"o = " + ChatFormatting.ITALIC + I18n.format("gui.sign.italic"),
							(int) ((x + 10) * (1.0 / 0.7)), (int) ((y - 90) * (1.0 / 0.7)), 120, 0x000000);
					this.fontRendererObj.drawSplitString("r = " + I18n.format("book.reset"),
							(int) ((x + 10) * (1.0 / 0.7)), (int) ((y - 84) * (1.0 / 0.7)), 120, 0x000000);

					for (int n = 0; n < 16; n++) {
						this.fontRendererObj.drawSplitString(this.tipcolorsymbols[n] + " = " + this.tiptextcolors[n],
				...
				this.fontRendererObj.drawString("\u00a7", (int) ((w + 198) * (1.0 / 1.25)),
				...
				this.fontRendererObj.drawString(I18n.format("gui.sign.scale"), (int) ((w + 195) * (1.0 / 0.8)),
						(int) ((h + 196) * (1.0 / 0.8)), 0x000000, false);
				this.fontRendererObj.drawString(I18n.format("gui.sign.format"), (int) ((w + 208) * (1.0 / 0.8)),
						(int) ((h + 221) * (1.0 / 0.8)), 0x000000, false);
				this.fontRendererObj.drawString(
						I18n.format("gui.sign.linenum") + " = " + ChatFormatting.GREEN
								+ (this.currentLine + 1),
						(int) ((w + 195) * (1.0 / 0.8)), (int) ((h + 233) * (1.0 / 0.8)), 0x000000, false);
				GL11.glPopMatrix();
				this.fontRendererObj.drawString(scaleTextStrings[this.textScales[this.currentLine]],
				...
				if (x > (w + 184) && x <= (w + 193) && y > (h + 219) && y <= (h + 230)) {
					...
					this.fontRendererObj.drawSplitString(I18n.format("gui.sign.tooltip9"),
							(int) ((x + 10) * (1.0 / 0.7)), (int) ((y - 4) * (1.0 / 0.7)), 120, 0x000000);
					GL11.glPopMatrix();
				}
		...
		if (signTile.getStackInSlot(0) != null) {
			GL11.glPushMatrix();
			...
			EntityItem item1 = new EntityItem(mc.theWorld, 0, 0, 0, signTile.getStackInSlot(0));
			item1.hoverStart = 0f;
...
//			myItemRenderer.renderItem(signTile.getStackInSlot(0), ItemCameraTransforms.TransformType.FIXED);
		...
		if (signTile.getStackInSlot(1) != null) {
			...
			EntityItem item2 = new EntityItem(mc.theWorld, 0, 0, 0, signTile.getStackInSlot(1));
			item2.hoverStart = 0f;
			...
			myItemRenderer.renderItemAndEffectIntoGUI(this.fontRendererObj, this.mc.getTextureManager(), signTile.getStackInSlot(1), 0,0);
			GL11.glEnable(GL11.GL_LIGHTING);
			GL11.glPopMatrix();
